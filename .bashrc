...
# Integrate MSYS2 tools in git bash
# export PATH="/c/msys64/usr/bin:$PATH"

# Fix lscpu for Windows Git Bash
#CPU_INFO=$(wmic cpu get NumberOfCores,NumberOfLogicalProcessors /format:list | grep "NumberOfLogicalProcessors" | cut -d= -f2 | tr -d '\r')
#CPU_INFO="${CPU_INFO} threads"

# Fix uptime for Windows Git Bash
#UPTIME=$(powershell.exe -Command "& {(get-date) - (gcim Win32_OperatingSystem).LastBootUpTime | select -ExpandProperty Days} days")
